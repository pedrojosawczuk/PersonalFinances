...
namespace PersonalFinances.UnitTests
{
    public class UserControllerTests
   {
      ...
      public UserControllerTests()
      {
         ...
         // Configurar o contexto HTTP simulado
      ...
      public async Task Verify_ValidToken_ReturnsOk()
      {
         ...
         _mockUserService.Setup(s => s.GetUserById(It.IsAny<long>())).ReturnsAsync(user);
      ...
      public async Task Login_ValidCredentials_ReturnsOk()
      {
         ...
         _mockUserService.Setup(s => s.IsEmailValid(user.Email)).Returns(true);
         _mockUserService.Setup(s => s.AuthenticateUser(user.Email, user.Password)).ReturnsAsync(dbUser);
         _mockUserService.Setup(s => s.GenerateJwtToken(dbUser)).Returns(tokenString);
